...
namespace BDM.App.UniversalApp.Utils
{
    ...
    internal sealed class SuspensionManager
    {
        ...
        private const string memoryStackFilename = "_memoryStack.xml";
        ...
        public static async Task SaveAsync()
        {
            try
            {
                ...
                // Get an output stream for the SessionState file and write the state asynchronously
                StorageFile memoryFile = await ApplicationData.Current.LocalFolder.CreateFileAsync(memoryStackFilename, CreationCollisionOption.ReplaceExisting);
                await FileIO.WriteTextAsync(memoryFile, NavigationMemoryHelper.SerializeStack());
            }
            catch (Exception e)
            {
        ...
        public static async Task RestoreAsync(String sessionBaseKey = null)
        {
            ...
            try
            {
                ...
                StorageFile memoryFile = await ApplicationData.Current.LocalFolder.GetFileAsync(memoryStackFilename);
                NavigationMemoryHelper.LoadInStack(await FileIO.ReadTextAsync(memoryFile));
